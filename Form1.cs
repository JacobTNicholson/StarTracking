        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (var i = 1; i < playerCount + 1; i++)
            {
                if (i == 0)
                {
                    ...
                    _txt.Location = new System.Drawing.Point(175, 85);
                    _txt.Text = "helloo";
                    this.Controls.Add(_txt);

                    Label lbl = new Label();
                    lbl.Text = "I am a label";
                    lbl.Location = new System.Drawing.Point(85, 85); ;
                ...
                else
                {
                    ...
                    int newY = 33 * i;
                    _txt.Name = "textBox0" + i;
                    _txt.Location = new System.Drawing.Point(175, newY);
                    _txt.Text = "Enter player " + i + "Name";
                    this.Controls.Add(_txt);

                    Label lbl = new Label();
                    lbl.Text = "Player" + i;
                    lbl.Location = new System.Drawing.Point(85, newY);
                    this.Controls.Add(lbl);
